...
@Order(10)
@Component
public class ChangeQrPasswordCallbackHandler implements CallbackHandler {
    private final QrWorkflow workflow;
    private final TelegramGateway telegram;

    public ChangeQrPasswordCallbackHandler(QrWorkflow workflow, TelegramGateway telegram) {
